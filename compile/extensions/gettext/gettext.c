...
#  define dcgettext(domain, msgid, category) ((char *)(msgid))
#  define textdomain(domain) ((char *)((domain) ? (domain) : ""))
#  define bindtextdomain(domain, dir) ((char *)((domain) ? (domain) : ""))
#  define bind_textdomain_codeset(domain, codeset) ((char *)((domain) ? (domain) : ""))
# endif
#else
# include <libintl.h>
#endif
